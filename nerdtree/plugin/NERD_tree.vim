...
if !nerdtree#runningWindows()
    call s:initVariable("g:NERDTreeDirArrowExpandable", "â–¸")
    call s:initVariable("g:NERDTreeDirArrowCollapsible", "â–¾")
else
...
"ÏÂÃæÊÇ×Ô¶¨ÒåµÄÃüÁî
"´ò¿ªÄ¿Â¼ËùÔÚµÄÎÄ¼þ¼Ð
call s:initVariable("g:NERDTreeMapGoLocation","ge")
if nerdtree#runningWindows()
    call s:initVariable("g:NERDTreeMapGoLocationCmd", 'explorer ')
else
    "TODO²»ÊÇwindowÉÏÃæµÄ´ò¿ªÎÄ¼þÄ¿Â¼¼ÐËùÔÚµÄÄ¿Â¼ÈÔÈ»ÐèÒª½øÒ»²½È·ÈÏ
endif
